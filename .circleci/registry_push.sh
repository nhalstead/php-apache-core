...
docker tag $IMAGE_PATH:$CIRCLE_BUILD_NUM $IMAGE_PATH:${CIRCLE_BRANCH}_${TAG_PREFIX}${CIRCLE_BUILD_NUM}
docker tag $IMAGE_PATH:$CIRCLE_BUILD_NUM $IMAGE_PATH:${TAG_PREFIX}latest
docker tag $IMAGE_PATH:$CIRCLE_BUILD_NUM $IMAGE_PATH:latest_${TAG_PREFIX}${CIRCLE_BRANCH}
